...
def folder(DIR):
    ...
    if not checkIfNecessaryPathsAndFilesExist(DIR):
        return
    # end if
    ...
    if not os.path.isdir(TEST_IMAGES_DIR):
        print("the given image directory does not seem to be a valid directory, check file / directory paths")
        return
    # end if
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    list.append(
                        "\t\t\t\t\t\t\t\t\t\t\t\tOBJECT APPEARS TO BE : " + strClassification + "\n\t\t\t\t\t\t\t\t\t\t\t\tCONFIDENCE     : " + "{0:.2f}".format(
                            scoreAsAPercent) + "%")
                ...
                print(strClassification + " : " + "{0:.4f}".format(presentedAsAPercent) + " %")
                str1 = ("\n\t\t\t\t\t\t\t\t\t\t\t\t" + strClassification + " : " + "{0:.4f}".format(
                    presentedAsAPercent) + " %")
                list.append(str1)
                list1.append(strClassification)
                list2.append("")
...
def main():
    ...
    if not checkIfNecessaryPathsAndFilesExist(TEST_IMAGES_DIR):
        return
    # end if
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    list.append("\t\t\t\t\t\t\t\t\t\t\t\tOBJECT APPEARS TO BE : " + strClassification + "\n\t\t\t\t\t\t\t\t\t\t\t\tCONFIDENCE     : " + "{0:.2f}".format(scoreAsAPercent) + "%")
                    # write the result on the image
                ...
                # for any prediction, show the confidence as a ratio to five decimal places
                print(strClassification + " : " +  "{0:.4f}".format(presentedAsAPercent)+" %")
                str1=("\n\t\t\t\t\t\t\t\t\t\t\t\t"+strClassification + " : " +  "{0:.4f}".format(presentedAsAPercent)+" %")
                list.append(str1)
                list1.append(strClassification)
                list2.append("")
...
#######################################################################################################################
def checkIfNecessaryPathsAndFilesExist(TEST_IMAGES_DIR):
